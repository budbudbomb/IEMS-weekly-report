                    ...
                    <table style="width: 100%; border-collapse: collapse; text-align: left;">
                        <thead>
                            <tr style="background: rgba(0,0,0,0.02); border-bottom: 1px solid var(--border-subtle);">
                                <th style="padding: 1.25rem 1.5rem; color: #06b6d4; font-weight: 800; font-size: 1.1rem; width: 60%;">Document Name</th>
                                <th style="padding: 1.25rem 1.5rem; color: #06b6d4; font-weight: 800; font-size: 1.1rem;">Current Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr style="border-bottom: 1px solid var(--border-subtle);">
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">Project Plan</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: var(--bg-page); color: var(--text-muted); border: 1px solid var(--border-subtle); padding: 0.3rem 0.75rem; font-size: 0.85rem;">To be started</span></td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--border-subtle);">
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">DPR</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: var(--color-done-bg); color: var(--color-done); padding: 0.3rem 0.75rem; font-size: 0.85rem;">Prepared</span></td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--border-subtle);">
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">RTM</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: rgba(245, 158, 11, 0.15); color: #b45309; padding: 0.3rem 0.75rem; font-size: 0.85rem;">Pending</span></td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--border-subtle);">
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">Concept note</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: rgba(245, 158, 11, 0.15); color: #b45309; padding: 0.3rem 0.75rem; font-size: 0.85rem;">Pending</span></td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--border-subtle);">
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">BRD</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: var(--bg-page); color: var(--text-muted); border: 1px solid var(--border-subtle); padding: 0.3rem 0.75rem; font-size: 0.85rem;">To be started</span></td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--border-subtle);">
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">SRS</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: var(--bg-page); color: var(--text-muted); border: 1px solid var(--border-subtle); padding: 0.3rem 0.75rem; font-size: 0.85rem;">To be started</span></td>
                            </tr>
                            <tr style="border-bottom: 1px solid var(--border-subtle);">
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">Process flows</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: var(--color-progress-bg); color: var(--color-progress); padding: 0.3rem 0.75rem; font-size: 0.85rem;">In progress</span></td>
                            </tr>
                            <tr>
                                <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: var(--text-primary);">User Manuals</td>
                                <td style="padding: 1.25rem 1.5rem;"><span class="status-badge" style="background: var(--color-progress-bg); color: var(--color-progress); padding: 0.3rem 0.75rem; font-size: 0.85rem;">In progress</span></td>
                            </tr>
                        </tbody>
                    </table>
