...
function isCategoryHeader(row, colIdx) {
    ...
    if (categories.some(cat => pName === cat || pName.startsWith(cat))) {
        // If it has development status, it's an actual page row, not a header
        if (!isEmptyOrHyphen(devVal)) {
            return false;
        }
        return true;
    }
                    ...
                    <div class="new-pres-card-grid">
                        ...
                        <div class="new-kpi-box" style="justify-content: space-between;">
                            ...
                            <div style="display: flex; align-items: center;">
                                ...
                                <div style="width: 2px; height: 1.2rem; background: rgba(0,0,0,0.1); margin: 0 0.5rem; flex-shrink: 0;"></div>
                                <div class="new-kpi-val" style="color: var(--text-primary); flex: 1; font-size: 0.85rem; line-height: 1.1;">(${internalStatus})</div>
                            </div>
                        </div>
                        <div class="new-kpi-box" style="justify-content: space-between;">
                            ...
                            <div style="display: flex; align-items: center;">
                                ...
                                <div style="width: 2px; height: 1.2rem; background: rgba(0,0,0,0.1); margin: 0 0.5rem; flex-shrink: 0;"></div>
                                <div class="new-kpi-val" style="color: var(--text-primary); flex: 1; font-size: 0.85rem; line-height: 1.1;">(${clientStatus})</div>
                            </div>
                        </div>
                    </div>
